...
import (
	...
	"github.com/gtck520/ConsoleIM/common/setting"
)
...
type NomalModel struct {
	ID        uint64    `gorm:"column:id;primary_key;auto_increment;" json:"id" form:"id"`                               // 主键
	CreatedAt time.Time `gorm:"column:created_at;type:datetime;default:0;not null;" json:"created_at" form:"created_at"` // 创建时间
	UpdatedAt time.Time `gorm:"column:updated_at;type:datetime;default:0;not null;" json:"updated_at" form:"updated_at"` // 更新时间
}
